...
async function run() {
  ...
  const forwardTx = createMockBridgeTx({
  ...
  const zcashUnlockTx = createMockBridgeTx({ txid: 'bridge_tx_back_' + Date.now(), commitment: unlockCommitment, nullifier: unlockNullifier, proof: unlockProof, amount: 500, recipient: 'zcash1qrecipient' });
